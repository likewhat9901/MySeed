...
import { UndoRedo, GridToggle, EditModeToggle } from './CanvasOverlay'
...
export default function Canvas() {
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundImage: showGrid ? `
          linear-gradient(to right, #c8e6d4 1px, transparent 1px),
          linear-gradient(to bottom, #c8e6d4 1px, transparent 1px)
        ` : 'none',
    ...
    >
      ...
      {/* 좌상단 오버레이: Undo/Redo + 그리드 토글 + 편집 모드 */}
